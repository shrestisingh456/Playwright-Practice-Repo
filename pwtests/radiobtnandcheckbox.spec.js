...
await newpage.locator("[placeholder='Enter Text']").nth(0).fill("Question 95")
...
await newpage.locator("[maxlength='200']").fill("question 5")
...
await newpage.locator("#quizReuiredCheckBox1").uncheck()
await newpage.locator("[name='isCorrect']").nth(0).click()
await newpage.locator(".btn.btn-primary.flex-grow-1.flex-sm-grow-0.flex-basis-half.flex-basis-sm-auto").click()
await newpage.locator(".d-flex.justify-content-end.float-end button").nth(1).click()
